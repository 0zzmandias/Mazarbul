...
import { cx, formatScore, formatDate } from "../../../utils/formatters";
...
export default function ReviewCard({ review, t }) {
  ...
  // Prioriza o posterUrl da mídia vinculada
  const posterUrl = review.media?.posterUrl || review.posterUrl;
  ...
  return (
    ...
    <Link
    to={`/media/${review.type}/${review.mediaId}`}
    className="shrink-0"
    >
    {posterUrl ? (
      <img
